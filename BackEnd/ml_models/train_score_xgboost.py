...
print("=" * 70)
print("🤖 XGBoost SCORE PREDICTION MODEL TRAINING - IPL DATA")
print("=" * 70)
...
model_path = os.path.join(model_dir, 'model_score_xgb.pkl')
...
print("\n" + "=" * 70)
print("✅ XGBOOST SCORE PREDICTION TRAINING COMPLETE!")
print("=" * 70)
print(f"\n🎯 Next Step: Run 'python ml_models/train_score_random_forest.py'")